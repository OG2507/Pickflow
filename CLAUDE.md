...
Custom warehouse management system for Oceanus Group. Next.js 15 (App Router), Supabase (PostgreSQL), TypeScript. Runs locally on localhost:3000 only — no cloud deployment.
